...
const Detail = () => {
  ...
  <p className="hidden md:flex text-gray-600 text-lg">{data.description}</p>

  <div>
    <del className="text-red-500 text-lg">Price: {data.price} $</del>
    <p className="text-xl font-semibold text-green-600 mt-2">
      Discounted Price: {(data.price - data.price * (data.discountPercentage / 100)).toFixed(2)} $
    </p>
  </div>
  ...
  <p className="text-gray-700 text-lg">Availability Status: {data.availabilityStatus}</p>
