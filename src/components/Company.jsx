...
const company = () => {
  return (
    <div className="container max-w-[1332px] mx-auto px-4">
        <div className='flex items-center gap-4  mt-[50px] mb-4'><p className='opacity-35'>Home
        </p> <FaAngleRight/> <p>About the company
        </p></div>
        <div className='flex flex-col items-center gap-8 sm:flex-row justify-between  p-4'>
            <div className=' w-[350px] sm:w-[450px]'>
             <p className='font-bold text-6xl mb-9'>About the company
             </p>
             <div className='flex flex-col gap-5'> 
              {companyCard.map((card)=>(
                <div key={card} className='rounded-2xl flex flex-col justify-between gap-16 p-8 bg-[#2fbad314]'>
