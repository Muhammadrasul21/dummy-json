...
<div onClick={()=> setOneItem(null)} className="fixed top-0 left-0 w-full h-screen bg-[#0005]"></div>
           <div className="p-4 fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white w-[60%] min-h-[80%] grid sm:grid-cols-2 grid-cols-1 ">
             <div>
             ...
             <div className='flex flex-col gap-6 '>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                 <div className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-8 py-3 text-center me-2 mb-2 ountline-none">
